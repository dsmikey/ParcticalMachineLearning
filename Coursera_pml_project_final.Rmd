...
```
### Decision Tree model: cross validation and out of sample error= 1-accuracy = 25.54%
```{r results = 'hide', fig.show="hide"}
...
### Random Forest model: cross validation and out of sample error = 1-accuracy = 0.71%
```{r results = 'hide', fig.show="hide"}
library(randomForest)
...
### Boosting model: cross validation and out of sample error= 1-accuracy = 4.01%
```{r results = 'hide', fig.show="hide"}
library(gbm)
